...
import { Text, View, StyleSheet, TouchableOpacity, Image, Linking, FlatList } from 'react-native';
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            <View style={{width: '100%', marginBottom: 6}}> 
                                <View style={{paddingLeft: 5}}> 
                                    ...
                                    <Text style={{fontSize: 18, width: '70%'}}>{item.descricao}</Text>
                                    <Text style={{fontSize: 14}}>Data de Expiração: {item.data}</Text>
                                </View>
                            </View>
                        </View>
