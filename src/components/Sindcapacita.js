            ...
            <TouchableOpacity onPress={() => this.openModal()}>
              ...
              >
                <Image
                  source={{
                    uri:
                      "https://www.institutoae.com.br/wp-content/uploads/2017/05/Imagem_destacada_conteudo_BLOG_10-dicas-para-dar-um-UP-nos-estudos-598x300.png",
                  }}
                ...
                <View style={styles.gradient}>
                  <Text
                    style={{
                      position: "absolute",
                      bottom: 70,
                      backgroundColor: "rgba(73, 52, 163, 0.7)",
                      color: "#fff",
                      fontSize: 24,
                      padding: 5,
                    }}
                  ...
                  >
                    Cursos recomendados por nossa equipe técnica
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity>
              ...
              >
                ...
                <View style={styles.gradient}>
                  ...
                  >
                    Cursos que visam melhorar a qualidade de vida
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity>
              ...
              >
                <Image
                  source={{
                    uri:
                      "https://www.cpp.org.br/media/k2/items/cache/e7fcaaeeb7f1b4e30b0e76a88fbe4d98_XL.jpg",
                  }}
                  style={[StyleSheet.absoluteFill, { borderRadius: 2 }]}
                />
                <View style={styles.gradient}>
                  ...
                  >
                    Que tal aprender uma nova língua?
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity>
              ...
              >
                <Image
                  source={{
                    uri:
                      "https://www.catho.com.br/educacao/blog/wp-content/uploads/sites/2/2018/10/2018-10-03-como-funciona-o-curso-de-administracao.png",
                  }}
                  style={[StyleSheet.absoluteFill, { borderRadius: 2 }]}
                />
                <View style={styles.gradient}>
          ...
          <View style={{ flex: 1, justifyContent: "center", padding: 10 }}>
            ...
            <View>
              <View style={{ backgroundColor: "#eee", margin: 5 }}>
                ...
                <View style={styles.line}>
                  <View
                    style={{ width: "70%", marginBottom: -5, borderRadius: 2 }}
                  >
