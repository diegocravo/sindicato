                        ...
                        > 
                            <View style={{ width: width-20, height: 150, backgroundColor:'#000', marginBottom: -5, borderRadius: 5}}>
                                ...
                                <View style={styles.gradient}>
                                    <Text style={{ position: 'absolute', bottom: 70, backgroundColor: '#4934A3', color: '#fff', fontSize: 24, padding: 5 }}>Cursos Recomendados</Text>
                    ...
                    <View style={styles.card}>
                        <TouchableOpacity> 
                            <View style={{ width: width-20, height: 150, backgroundColor:'#000', marginBottom: -5, borderRadius: 5}}>
                                ...
                                <View style={styles.gradient}>
                                    <Text style={{ position: 'absolute', bottom: 70, backgroundColor: '#4934A3', color: '#fff', fontSize: 24, padding: 5 }}>Desenvolvimento Pessoal</Text>
                                    <Text style={{ position: 'absolute', bottom: 10, color: '#fff', fontSize: 15, padding: 5 }}>Cursos que visam melhorar a qualidade de vida e desenvolvolvimento de habilidades pessoais</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.card}>
                        <TouchableOpacity> 
                            <View style={{ width: width-20, height: 150, backgroundColor:'#000', marginBottom: -5, borderRadius: 5}}>
                                ...
                                <View style={styles.gradient}>
                                    <Text style={{ position: 'absolute', bottom: 70, backgroundColor: '#4934A3', color: '#fff', fontSize: 24, padding: 5 }}>Línguas</Text>
                    ...
                    <View style={styles.card}>
                        <TouchableOpacity> 
                            <View style={{ width: width-20, height: 150, backgroundColor:'#000', marginBottom: -5, borderRadius: 5}}>
                                ...
                                <View style={styles.gradient}>
                                    <Text style={{ position: 'absolute', bottom: 70, backgroundColor: '#4934A3', color: '#fff', fontSize: 24, padding: 5 }}>Extensão</Text>
                                    <Text style={{ position: 'absolute', bottom: 10, color: '#fff', fontSize: 15, padding: 5 }}>Cursos de curta e média duração focados em assuntos específicos</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    </View>
