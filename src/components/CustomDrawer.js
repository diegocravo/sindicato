    ...
    return(
        <View style={styles.container}>
            ...
            <Modal 
                ...
                onSwipeComplete={toggleModal} swipeDirection="right"
            ...
            <View style={{ flex: 1, justifyContent:'center', }}>
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', color: '#4934A3', marginLeft: 30,}}>Nome</Text>
                <TextInput 
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', color: '#4934A3', marginLeft: 30,}}>Data de Nascimento</Text>
                <TextInput 
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', color: '#4934A3', marginLeft: 30,}}>E-mail</Text>
                <TextInput 
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', color: '#4934A3', marginLeft: 30,}}>Currículo</Text>
                <TextInput 
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', color: '#4934A3', marginLeft: 30,}}>Senha</Text>
                <TextInput 
                    placeholder="*********" 
                    placeholderTextColor="#000"
                    secureTextEntry={true}
